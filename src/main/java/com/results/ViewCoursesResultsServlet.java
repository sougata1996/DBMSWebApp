...
/**
 * Servlet implementation class ViewCoursesResultsServlet
 */
public class ViewCoursesResultsServlet extends HttpServlet {
     ...
     */
    public ViewCoursesResultsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/viewcourses_results.jsp");
		dispatcher.forward(request, response);
	}
